...
void eatAss()
{
    LOG("Bro this tastes like shit.");
    LOG("I gotta find a way out. She ain't even wipe, man.");
    
    if (runExploit())
    {
        LOG("Ay! She let me take a breather! Here's my chance to run.");
        return;
        
    } else {
        LOG("AAAAAA IM STUCK, **dies**");
        exit(1);
    }
...
- (IBAction)go:(id)sender {
     ...
     dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0ul), ^{
         ...
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Jailbreaking..."
         ...
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Exploit done!" forState:UIControlStateNormal];
         ...
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Started jelbrekLib!" forState:UIControlStateNormal];
             
         });
         
         rootify(getpid());
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Got root!" forState:UIControlStateNormal];
         ...
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Set csflags!" forState:UIControlStateNormal];
         ...
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Set platformize!" forState:UIControlStateNormal];
         ...
         UnlockNVRAM();
         dispatch_async(dispatch_get_main_queue(), ^{
             [self->_button setTitle:@"Unclocked nvram!" forState:UIControlStateNormal];
             
         });
         
         dispatch_async(dispatch_get_main_queue(), ^{
            [self->_button setTitle:@"Installing bootstrap!" forState:UIControlStateNormal];
         ...
         if (!fileExists("/var/containers/Bundle/.installed_rootlessJB3")) {
             ...
             dispatch_async(dispatch_get_main_queue(), ^{
                 [self->_button setTitle:@"Installed bootstrap!" forState:UIControlStateNormal];
         ...
         if (self.tweaks.isOn) {
             ...
             dispatch_async(dispatch_get_main_queue(), ^{
                 [self->_button setTitle:@"Done!" forState:UIControlStateNormal];
...
- (IBAction)uninstall:(id)sender {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0ul), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [self->_button2 setTitle:@"Jailbreaking..."
        ...
        eatAss();
        dispatch_async(dispatch_get_main_queue(), ^{
            [self->_button2 setTitle:@"Exploit done!" forState:UIControlStateNormal];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [self->_button2 setTitle:@"Uninstalled!"
...
//so uh.... wheres your old sockport?/fix //idfk
@end
//yeah.......

//tbd is a collection of headers. Did we even init IOSurface? yes, butttt we never inited offsets....

//this is why u need me
//lmao owo uwu owu so uh Teach me how to fuck up amfid owo
//call? YES NIGGA
//messenger?
//OF COURSE NIGGA
